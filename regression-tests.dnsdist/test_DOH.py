...
class DOHWithPCKS12Cert(object):
...
class TestDOHWithPCKS12CertNGHTTP2(DOHWithPCKS12Cert, DNSDistDOHTest):
    _dohLibrary = 'nghttp2'

class TestDOHWithPCKS12CertH2O(DOHWithPCKS12Cert, DNSDistDOHTest):
    _dohLibrary = 'h2o'
