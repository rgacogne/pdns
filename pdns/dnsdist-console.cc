...
const std::vector<ConsoleKeyword> g_consoleKeywords{
  ...
  { "newServerPolicy", true, "name, function [, needLock [, read-only]]", "create a policy object from a Lua function" },
  ...
  { "setPoolServerPolicyLua", true, "name, func, pool [, needLock [, read-only]]", "set the server selection policy for this pool to one named 'name' and provided by 'function'" },
  ...
  { "setServerPolicyLua", true, "name, function [, needLock [, read-only]]", "set server selection policy to one named 'name' and provided by 'function'" },
