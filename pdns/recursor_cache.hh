...
public:
  ...
  unsigned int size();
  unsigned int bytes();
  int32_t get(time_t, const DNSName &qname, const QType& qt, vector<DNSRecord>* res, const ComboAddress& who, vector<std::shared_ptr<RRSIGRecordContent>>* signatures=nullptr, vState* state=nullptr);
