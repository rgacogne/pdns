...
DynListener::DynListener(const ComboAddress& local): d_tcp(true), d_tid(0), d_ppid(0)
{
  listenOnTCP(local);
}

DynListener::DynListener(const string &progname): d_tcp(false), d_tid(0), d_ppid(0)
{
  if(!progname.empty()) {
