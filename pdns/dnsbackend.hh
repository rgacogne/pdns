...
public:
  ...
  */
  ...
  virtual bool getAllRRSets(const std::vector<DNSName>& names, int zoneId, const DNSPacket* pkt, std::vector<DNSZoneRecord>& records);
  ...
  static void fillSOADefaults(const DNSName& domain, SOAData& sd);
