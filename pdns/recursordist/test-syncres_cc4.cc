...
BOOST_AUTO_TEST_CASE(test_auth_zone_nodata)
{
  ...
  dr.d_type = QType::A;
  dr.d_ttl = 3600;
  dr.d_content = make_unique<ARecordContent>(ComboAddress("192.0.2.1"));
  ...
  dr.d_type = QType::SOA;
  dr.d_ttl = 3600;
  dr.d_content = make_unique<SOARecordContent>("pdns-public-ns1.powerdns.com. pieter\\.lexis.powerdns.com. 2017032301 10800 3600 604800 3600");
  ad.d_records.insert(dr);
...
BOOST_AUTO_TEST_CASE(test_auth_zone_nx)
{
  ...
  auto map = make_unique<SyncRes::domainmap_t>();
  (*map)[authZone] = ad;
  SyncRes::setDomainMap(map);
...
BOOST_AUTO_TEST_CASE(test_auth_zone_delegation)
{
  ...
  dr.d_type = QType::NS;
  dr.d_ttl = 3600;
  dr.d_content = make_unique<NSRecordContent>(ns);
  ad.d_records.insert(dr);
  ...
  dr.d_type = QType::A;
  dr.d_ttl = 3600;
  dr.d_content = make_unique<ARecordContent>(nsAddr);
  ad.d_records.insert(dr);
...
BOOST_AUTO_TEST_CASE(test_auth_zone_wildcard)
{
  ...
  dr.d_type = QType::A;
  dr.d_ttl = 3600;
  dr.d_content = make_unique<ARecordContent>(targetAddr);
  ad.d_records.insert(dr);
...
BOOST_AUTO_TEST_CASE(test_auth_zone_wildcard_with_ent)
{
  ...
  dr.d_type = QType::A;
  dr.d_ttl = 3600;
  dr.d_content = make_unique<ARecordContent>(targetAddr1);
  ad.d_records.insert(dr);
  ...
  dr.d_type = QType::A;
  dr.d_ttl = 3600;
  dr.d_content = make_unique<ARecordContent>(targetAddr2);
  ad.d_records.insert(dr);
...
BOOST_AUTO_TEST_CASE(test_auth_zone_cache_only)
{
  ...
  dr.d_type = QType::A;
  dr.d_ttl = 3600;
  dr.d_content = make_unique<ARecordContent>(addr);
  ad.d_records.insert(dr);
...
BOOST_AUTO_TEST_CASE(test_dnssec_rrsig)
{
  ...
  skeyset_t keyset;
  keyset.insert(make_unique<DNSKEYRecordContent>(dpk.getDNSKEY()));

  std::vector<std::unique_ptr<RRSIGRecordContent>&> sigs;
  sigs.push_back(make_unique<RRSIGRecordContent>(rrc));
