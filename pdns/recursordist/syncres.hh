...
private:
  ...
  vState checkWildcardProof(const DNSName& name, const QType& type, const LWResult& lwr, vState& state, unsigned int depth, const std::string& prefix, unsigned int wildcardLabelsCount);
