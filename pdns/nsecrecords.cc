...
{
  return make_unique<NSECRecordContent>(content);
}
...
{
  auto ret = make_unique<NSECRecordContent>();
...
{
  return make_unique<NSEC3RecordContent>(content);
}
...
{
  auto ret = make_unique<NSEC3RecordContent>();
...
{
  return make_unique<NSEC3PARAMRecordContent>(content);
}
...
{
  auto ret = make_unique<NSEC3PARAMRecordContent>();
  pr.xfr8BitInt(ret->d_algorithm); 
        pr.xfr8BitInt(ret->d_flags); 
        pr.xfr16BitInt(ret->d_iterations); 
  uint8_t len;
