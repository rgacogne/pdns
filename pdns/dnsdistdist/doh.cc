...
public:
  ...
  void handleResponse(const struct timeval& now, TCPResponse&& response) override
  {
    ...
    if (!dohUnit->ids.selfGenerated) {
      ...
      VERBOSESLOG(infolog("Got answer from %s, relayed to %s (https), took %f us", dohUnit->downstream->d_config.remote.toStringWithPort(), dohUnit->ids.origRemote.toStringWithPort(), udiff),
