...
.. function:: newPacketCache(maxEntries[, maxTTL=86400[, minTTL=0[, temporaryFailureTTL=60[, staleTTL=60[, dontAge=false[, numberOfShards=1[, deferrableInsertLock=true[, parseECS=false]]]]]]]]) -> PacketCache

  .. versionchanged:: 1.3.0
    ``numberOfShards`` and ``deferrableInsertLock`` parameters added.

  .. versionchanged:: 1.3.1
    ``parseECS` parameter added.
